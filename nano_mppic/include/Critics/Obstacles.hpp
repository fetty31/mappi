...
class Obstacles : public Critic {
    ...
    public:
        ...
        void configure(std::string name, std::shared_ptr<costmap_2d::Costmap2DROS>& costmap_ros);
...
void Obstacles::configure(std::string name, std::shared_ptr<costmap_2d::Costmap2DROS>& costmap_ros){
