...
class Critic {
    ...
    protected:
        std::string name_;
        nano_mppic::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros_ptr_;
    ...
    public:
        ...
        virtual void configure(std::string name, nano_mppic::shared_ptr<nav2_costmap_2d::Costmap2DROS>& costmap_ros){
            name_ = name;
